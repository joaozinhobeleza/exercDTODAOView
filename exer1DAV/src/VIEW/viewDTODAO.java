 ...
 */
public class viewDTODAO extends javax.swing.JFrame {

    /** Creates new form viewDTODAO */
    public viewDTODAO() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewDTODAO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewDTODAO().setVisible(true);
            }
        });
    }
